...
This lab showed how software testing can change as the system grows. For example, in the beginning the testing process focused on unit-level checks, such as verifying if the Password Hasher class worked correctly and if the AuthenticationService accepted valid login credentials. 
